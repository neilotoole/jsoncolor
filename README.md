...
[![release](https://img.shields.io/badge/release-v0.5.0-green.svg)](https://github.com/neilotoole/jsoncolor/releases/tag/v0.5.0)
...
- `neilotoole/jsoncolor`: (this package) `v0.5.0`.
